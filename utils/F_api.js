      ...
      resolve([
        {
          ...
          is_mandatory: true,
          description:
            'Monthly faculty meeting to discuss department updates and upcoming events.',
        },
        {
          id: 2,
          ...
          is_mandatory: false,
          description:
            'Annual research symposium featuring presentations from faculty and graduate students.',
        },
        {
          id: 3,
          ...
          is_mandatory: true,
          description:
            'Curriculum committee meeting to review and approve course changes for the upcoming semester.',
        },
        {
          id: 4,
          ...
          is_mandatory: true,
          description:
            'Annual department retreat for team building and strategic planning.',
        },
      ]);
    }, 500);
  });
    ...
    setTimeout(() => {
      const leaveRequests = [
        ...
        },
        {
          ...
          reason:
            'Conference attendance - International Conference on Computer Science Education',
          status: 'Pending',
