    ...
    <form onSubmit={handleSubmit} className="space-y-6 bg-white rounded-lg shadow p-6">
        ...
        <>
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={handleChange}
              className={`input ${errors.receiver_id ? 'border-red-500' : ''} w-full md:w-72 max-w-full`}
            >
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              className={`input ${errors.subject ? 'border-red-500' : ''} w-full md:w-72 max-w-full`}
      ...
      <div className="form-group">
        ...
        <textarea
          ...
          onChange={handleChange}
          rows="5"
          className={`input ${errors.body ? 'border-red-500' : ''} w-full md:w-72 max-w-full`}
