...
export default function FacultyMessagesInbox() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <FacultySidebar activePage="messages-received" />
                ...
                <div className="border-r border-gray-200 overflow-y-auto">
                  ...
                  {messages.length > 0 ? (
                    <div className="divide-y divide-gray-200">
                      {messages.map((message) => (
                        <div
                          ...
                          } ${!message.read && !selectedMessage ? "bg-blue-50" : ""}`}
                          onClick={() => setSelectedMessage(message)}
                        >
                          <div className="flex items-start justify-between">
                            <div className="flex items-start space-x-2">
                              <div className="flex-shrink-0 mt-1">{getSenderIcon(message.sender_type)}</div>
                              <div>
                                <h3 className="text-sm font-medium text-gray-800 line-clamp-1">{message.subject}</h3>
                                <p className="text-xs text-gray-500 line-clamp-1">{message.sender_name}</p>
                              </div>
                            </div>
                    ...
                    <div className="text-center py-16">
                      ...
                      <h3 className="text-lg font-medium text-gray-800 mb-1">No Messages</h3>
                      ...
                      <div className="p-4 border-b border-gray-200">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <div>
                              <h3 className="text-sm font-medium text-gray-800">{selectedMessage.sender_name}</h3>
