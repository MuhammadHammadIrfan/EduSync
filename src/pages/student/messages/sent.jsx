...
import { Send, User, Clock, Trash2, Mail, Loader2 } from "lucide-react"
import StudentSidebar from "../../../components/studentSiderbar"
import { getSentMessages } from "../../../../utils/api/student"
...
export default function MessagesSent() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      <Head>
        <title>Messages Sent | EduSync</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      </Head>

      <StudentSidebar activePage="messages-sent" />
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex items-start space-x-2">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-500">{message.recipient_type}</p>
                              </div>
                            </div>
                      ...
                      >
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center">
                            ...
                            <div>
                              <p className="text-sm font-medium text-gray-800">To: {selectedMessage.recipient_name}</p>
