...
import { Calendar, Clock, MapPin, User, ChevronRight, ChevronLeft, Loader2 } from "lucide-react"
import StudentSidebar from "../../components/studentSiderbar"
import { getClassSchedule } from "../../../utils/api/student"
...
export default function ClassSchedule() {
  ...
  // In the useEffect that fetches class schedule:
  ...
  useEffect(() => {
    async function fetchSchedule() {
      try {
        ...
        setSchedule(data || []); // Ensure we always have at least an empty array
        setLoading(false);
      } catch (err) {
                ...
                <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-sm">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-600">{cls.course_code}</span>
                    </div>
                  </div>
                </div>
              ))}
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <StudentSidebar activePage="class-schedule" />
